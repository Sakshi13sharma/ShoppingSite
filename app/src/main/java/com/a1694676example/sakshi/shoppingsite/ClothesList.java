...
public class ClothesList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.with(ClothesList.this).load(ph).into(imgv);
        txtnm.setText(nm);
        ...
        btn_trade.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(nm2.isEmpty())
                {
                    Toast.makeText(ClothesList.this,"Please Enter Name of Product",Toast.LENGTH_LONG).show();
                }
                else {
                    ...
                    bar.setAction("Cancel", new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Toast.makeText(ClothesList.this,"Trade Cancel",Toast.LENGTH_LONG).show();
                        }
                    });
                    bar.show();
                }
